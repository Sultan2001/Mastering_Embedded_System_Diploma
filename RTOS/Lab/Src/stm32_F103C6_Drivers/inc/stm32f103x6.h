...
#define NVIC_ISER0								*(vuint_32*)(NVIC_BASE_ + 0x00)  // set IRQ 0 -> 31
#define NVIC_ISER1								*(vuint_32*)(NVIC_BASE_ + 0x04)  // set IRQ 32 -> 63
#define NVIC_ISER2								*(vuint_32*)(NVIC_BASE_ + 0x08)	// set IRQ 64 -> 67
#define NVIC_ICER0								*(vuint_32*)(NVIC_BASE_ + 0x80)	// Clear IRQ 0 -> 31
#define NVIC_ICER1								*(vuint_32*)(NVIC_BASE_ + 0x84)	// Clear IRQ 32 -> 63
#define NVIC_ICER2								*(vuint_32*)(NVIC_BASE_ + 0x88)	// Clear IRQ 64 -> 67
