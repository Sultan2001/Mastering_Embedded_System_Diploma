...
#define GPIO_PINS_0			((uint_16)0x0001)		// Pin 0 selected
#define GPIO_PINS_1			((uint_16)0x0002)		// Pin 1 selected  10
#define GPIO_PINS_2			((uint_16)0x0004)		// Pin 2 selected  100
#define GPIO_PINS_3			((uint_16)0x0008)		// Pin 3 selected  1000
#define GPIO_PINS_4			((uint_16)0x0010)		// Pin 4 selected  1 0000
#define GPIO_PINS_5			((uint_16)0x0020)		// Pin 5 selected  10 0000
#define GPIO_PINS_6			((uint_16)0x0040)		// Pin 6 selected  100 0000
#define GPIO_PINS_7			((uint_16)0x0080)		// Pin 7 selected  1000 0000
#define GPIO_PINS_8			((uint_16)0x0100)		// Pin 8 selected  1 0000 0000
#define GPIO_PINS_9			((uint_16)0x0200)		// Pin 9 selected  10 0000 0000
#define GPIO_PINS_10		((uint_16)0x0400)		// Pin 10 selected 100 0000 0000
#define GPIO_PINS_11		((uint_16)0x0800)		// Pin 11 selected
#define GPIO_PINS_12		((uint_16)0x1000)		// Pin 12 selected
#define GPIO_PINS_13		((uint_16)0x2000)		// Pin 13 selected
#define GPIO_PINS_14		((uint_16)0x4000)		// Pin 14 selected
#define GPIO_PINS_15		((uint_16)0x8000)		// Pin 15 selected 1000 0000 0000 0000 = 32,768 DEC
...
//@ref GPIO_PINS_State_define
#define GPIO_PINS_State_SET 	1
#define GPIO_PINS_State_RESET 	0
